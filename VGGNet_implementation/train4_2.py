...
class Fit:
    def __init__(self, model, loss_fn, optimizer):
        ...
        # self.scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(self.optimizer, T_max=800//50)
        self.scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=200) # 250
